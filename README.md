...
* https://github.com/renzorlive/vimmaster (en) - Ещё одна игра по азам управления в VIM. Примечательна реализацией одним html-файлом (но для стилей извне подтягивается tailwindcss).
